...
sqoop import --connect jdbc:mysql://bigdata.bisa.ai:3306/barang --username root --password passwordaman --table barang --target-dir /barang --driver com.mysql.cj.jdbc.Driver --delete-target-dir --as-textfile

sqoop-eval --connect jdbc:mysql://bigdata.bisa.ai:3306/barang --username root --password passwordaman --query "select count(*) from barang"
sqoop-eval --connect jdbc:mysql://bigdata.bisa.ai:3306/barang --username root --password passwordaman --query "select * from barang"
