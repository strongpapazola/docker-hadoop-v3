...
if [ "$MULTIHOMED_NETWORK" = "1" ]; then
    ...
    # addProperty /etc/hadoop/core-site.xml hadoop.http.authentication.simple.realm bisa.ai
    # addProperty /etc/hadoop/core-site.xml hadoop.http.authentication.simple.users user1=password1,user2=password2
    # echo 'export HADOOP_OPTS="$HADOOP_OPTS -Dhadoop.http.authentication.simple.anonymous.allowed=false"' >> /etc/hadoop/hadoop-env.sh
fi
